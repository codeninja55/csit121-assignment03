...
public class PurchaseForm extends BaseForm implements FormFactory, PurchaseFormView {
    ...
    private PurchaseForm(PurchaseFormBuilder builder) {
        ...
        options.addElement(PurchaseType.ExistingCardPurchase.name);
        options.addElement(PurchaseType.NewCardPurchase.name);
        options.addElement(PurchaseType.CashPurchase.name);
    ...
    private void createCategoriesListForm() {
        ...
        categoriesList.forEach((Category cat) -> {
            ...
            FormFormattedTextField catValueTextField = new FormFormattedTextField(FormatterFactory.doubleFormat());
    ...
    private class FormListener implements ActionListener, ItemListener {
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == createBtn) {
                ...
                if (purchaseTypeCombo.getSelectedItem() == PurchaseType.NewCardPurchase.name && !anonCardRB.isSelected()) {
